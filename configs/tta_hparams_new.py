...
FD_ACCUP_SCENARIO_OVERRIDES = {
    ...
    backbone_scenario('CNN', 1, 0): {
        'batch_size': 96,
        'd_margin': 5.859529682609365e-10,
        'e_margin_scale': 1.027980345375144,
        'filter_K': 29,
        'fisher_alpha': 2538.768784163149,
        'freeze_bn_stats': True,
        'grad_clip': 0.7800306461497082,
        'grad_clip_value': 1.0,
        'include_warmup_support': True,
        'lambda_eata': 0.5011376676304993,
        'learning_rate': 7.77550049380744e-06,
        'lr_decay': 0.46852622075641803,
        'max_fisher_updates': 128,
        'memory_size': 1024,
        'momentum': 0.9086614204021437,
        'num_epochs': 25,
        'online_fisher': True,
        'pre_learning_rate': 0.0008720121571339645,
        'quantile': 0.9285054805599011,
        'safety_keep_frac': 0.8360678298463,
        'step_size': 28,
        'steps': 1,
        'tau': 11,
        'temperature': 0.7050289503687677,
        'train_backbone_modules': ['conv_block1', 'conv_block2'],
        'train_classifier': True,
        'train_full_backbone': False,
        'use_eata_reg': True,
        ...
        'use_quantile': True,
        'warmup_min': 120,
        'weight_decay': 2.230496067324172e-05,
    },

    backbone_scenario('CNN', 1, 2): {
        'batch_size': 104,
        'd_margin': 0.02022329245105437,
        'drop_last_eval': False,
        'drop_last_test': False,
        'e_margin_scale': 0.513635406333921,
        'filter_K': 23,
        'fisher_alpha': 6405.6272322065615,
        'freeze_bn_stats': True,
        'grad_clip': 0.7370605213641022,
        'grad_clip_value': 1.0,
        'include_warmup_support': True,
        'lambda_eata': 2.382136793718204,
        'learning_rate': 0.00016018648772384456,
        ...
        'num_epochs': 58,
        'online_fisher': True,
        'pre_learning_rate': 0.0007308763429295351,
        'quantile': 0.18801873038672295,
        'safety_keep_frac': 0.5510198404309534,
        'step_size': 21,
        'steps': 3,
        'tau': 11,
        'temperature': 1.0552871809536424,
        'train_backbone_modules': None,
        'train_classifier': True,
        'train_full_backbone': True,
        'use_eata_reg': True,
    ...
    backbone_scenario('CNN', 2, 3): {
        'batch_size': 88,
        'd_margin': 0.13678354061729886,
        'e_margin_scale': 0.27037598625479836,
        'filter_K': 29,
        'fisher_alpha': 6011.899677622921,
        'freeze_bn_stats': False,
        'grad_clip': 1.1902874017907406,
        'grad_clip_value': 1.0,
        'include_warmup_support': True,
        'lambda_eata': 1.5686274147648105,
        'learning_rate': 5.6244833322339405e-06,
        'lr_decay': 0.27893400774398824,
        'max_fisher_updates': 1024,
        'memory_size': 3328,
        'momentum': 0.9059954312683757,
        'num_epochs': 55,
        'online_fisher': True,
        'pre_learning_rate': 0.0006666955860767322,
        'quantile': 0.23871442914061566,
        'safety_keep_frac': 0.7162209256415448,
        'step_size': 32,
        'steps': 1,
        'tau': 5,
        'temperature': 1.8041418060234822,
        'train_backbone_modules': None,
        'train_classifier': True,
        'train_full_backbone': True,
        'use_eata_reg': True,
        ...
        'use_quantile': False,
        'warmup_min': 224,
        'weight_decay': 0.00042433459992096935,
    },
