...
HAR_ACCUP_SCENARIO_OVERRIDES = {
    ...
    backbone_scenario('CNN', 6, 23): {
        'batch_size': 16,
        'd_margin': 0.10485356487771601,
        'e_margin_scale': 0.7860760116721213,
        'filter_K': 13,
        'fisher_alpha': 2694.546075582264,
        'freeze_bn_stats': False,
        'grad_clip': 1.2510894134833388,
        'grad_clip_value': 0.5,
        'include_warmup_support': True,
        'lambda_eata': 0.42398787840765134,
        'learning_rate': 3.1562926470463736e-06,
        'lr_decay': 0.3584532007909739,
        ...
        'quantile': 0.24025122737432633,
        'safety_keep_frac': 0.43277367345311807,
        'step_size': 63,
        'steps': 5,
        'tau': 31,
        'temperature': 1.1738908580063783,
        'train_backbone_modules': None,
        'train_classifier': True,
        'train_full_backbone': True,
        'use_eata_reg': True,
    ...
    backbone_scenario('CNN', 7, 13): {
        'batch_size': 24,
        'd_margin': 0.03758522942724285,
        'e_margin_scale': 0.751690725641392,
        'filter_K': 17,
        'fisher_alpha': 389.38164566842437,
        'freeze_bn_stats': True,
        'grad_clip': 1.187522874514796,
        'grad_clip_value': 0.5,
        'include_warmup_support': True,
        'lambda_eata': 0.6551750834626421,
        'learning_rate': 2.169935004032944e-05,
        'lr_decay': 0.6749136175017815,
        'max_fisher_updates': 32,
        'memory_size': 2048,
        'momentum': 0.6336865400452851,
        'num_epochs': 15,
        'online_fisher': True,
        'pre_learning_rate': 0.0007753461397393872,
        'quantile': 0.3645770613212001,
        'safety_keep_frac': 0.7566642917184077,
        'step_size': 60,
        'steps': 2,
        'tau': 5,
        'temperature': 0.8070541207892883,
        ...
        'use_quantile': True,
        'warmup_min': 50,
        'weight_decay': 0.0005078966323778928,
    },

    backbone_scenario('CNN', 9, 18): {
        'batch_size': 16,
        'd_margin': 0.0908122416677225,
        ...
        'grad_clip_value': 0.25,
        'include_warmup_support': True,
        'lambda_eata': 0.6336514443981592,
