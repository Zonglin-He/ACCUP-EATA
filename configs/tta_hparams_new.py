...
HAR_ACCUP_SCENARIO_OVERRIDES = {
    ...
    scenario(6, 23): {
        'batch_size': 16,
        'd_margin': 0.0280216896193304,
        'e_margin_scale': 0.3752809699353473,
        'filter_K': 17,
        'fisher_alpha': 3305.6115781708813,
        'freeze_bn_stats': True,
        'grad_clip': 0.5330535152898641,
        'grad_clip_value': 0.05,
        'include_warmup_support': True,
        'lambda_eata': 2.0942662018915774,
        'learning_rate': 1.7320168747153725e-05,
        'lr_decay': 0.6118788645454953,
        'max_fisher_updates': 512,
        'memory_size': 512,
        'momentum': 0.9728361657024858,
        'num_epochs': 19,
        'online_fisher': False,
        'pre_learning_rate': 0.00017684870316275576,
        'quantile': 0.6777083044687557,
        'safety_keep_frac': 0.3409387313911912,
        'step_size': 67,
        'steps': 2,
        'tau': 22,
        'temperature': 1.8529011914772688,
        'train_backbone_modules': None,
        'train_classifier': False,
        'train_full_backbone': False,
        'use_eata_reg': True,
        ...
        'use_quantile': False,
        'warmup_min': 53,
        'weight_decay': 4.931202159260597e-05,
    },

    scenario(7, 13): {
        'batch_size': 24,
        'd_margin': 0.1314340040382209,
        'e_margin_scale': 0.2833934721030761,
        'filter_K': 17,
        'fisher_alpha': 7428.056602173928,
        'freeze_bn_stats': True,
        'grad_clip': 0.6928745330473367,
        'grad_clip_value': 0.05,
        'include_warmup_support': False,
        'lambda_eata': 1.4284311846914193,
        'learning_rate': 1.984985477963173e-05,
        'lr_decay': 0.30150737095780833,
        'max_fisher_updates': 1024,
        'memory_size': 1024,
        'momentum': 0.9725646793767917,
        'num_epochs': 23,
        'online_fisher': False,
        'pre_learning_rate': 9.497551397480874e-05,
        'quantile': 0.739509494104232,
        'safety_keep_frac': 0.39839757744219434,
        'step_size': 32,
        'steps': 3,
        'tau': 24,
        'temperature': 2.508554226838988,
        'train_backbone_modules': None,
        'train_classifier': False,
        'train_full_backbone': False,
        'use_eata_reg': True,
        ...
        'use_quantile': True,
        'warmup_min': 282,
        'weight_decay': 1.5363632193107853e-05,
    },

    scenario(9, 18): {
        'batch_size': 16,
        'd_margin': 0.09005921897569175,
        'e_margin_scale': 0.7829077695693498,
        'filter_K': 33,
        'fisher_alpha': 4824.643470582223,
        'freeze_bn_stats': False,
        'grad_clip': 1.4703983181285782,
        'grad_clip_value': 0.1,
        'include_warmup_support': True,
        'lambda_eata': 1.1053870687866298,
        'learning_rate': 4.344709351609951e-05,
        'lr_decay': 0.7038553812073598,
        'max_fisher_updates': 1024,
        'memory_size': 768,
        'momentum': 0.9166421496324169,
        'num_epochs': 20,
        'online_fisher': False,
        'pre_learning_rate': 0.0003616267663501354,
        'quantile': 0.7699626603250957,
        'safety_keep_frac': 0.8941947101360999,
        'step_size': 46,
        'steps': 1,
        'tau': 27,
        'temperature': 0.6508946838849046,
        'train_backbone_modules': None,
        'train_classifier': True,
        'train_full_backbone': True,
        'use_eata_reg': True,
        ...
        'use_quantile': True,
        'warmup_min': 217,
        'weight_decay': 0.00010031297511281035,
    },

    scenario(12, 16): {
        'batch_size': 16,
        'd_margin': 0.03628972629750953,
        'e_margin_scale': 0.4832447349333474,
        'filter_K': 15,
        'fisher_alpha': 553.6599243531803,
        'freeze_bn_stats': True,
        'grad_clip': 0.7761121293878918,
        'grad_clip_value': 0.25,
        'include_warmup_support': False,
        'lambda_eata': 1.3705696776775687,
        'learning_rate': 0.00028107617268456945,
        'lr_decay': 0.37163832685382836,
        'max_fisher_updates': 512,
        'memory_size': 3328,
        'momentum': 0.9679297178631893,
        'num_epochs': 14,
        'online_fisher': False,
        'pre_learning_rate': 0.00019264985675791855,
        'quantile': 0.7249265405871392,
        'safety_keep_frac': 0.22453740500615554,
        'step_size': 44,
        'steps': 5,
        'tau': 23,
        'temperature': 1.7177198907125661,
        ...
        'use_quantile': True,
        'warmup_min': 96,
        'weight_decay': 0.0008158175019453209,
    },
}
...
FD_ACCUP_SCENARIO_OVERRIDES = {
    backbone_scenario('CNN', 0, 1): {
        'batch_size': 112,
        'd_margin': 0.10491853290742853,
        'e_margin_scale': 0.8534651424922038,
        'filter_K': 5,
        'fisher_alpha': 855.7875971691615,
        'freeze_bn_stats': True,
        'grad_clip': 0.6933032023443515,
        'grad_clip_value': 0.1,
        'include_warmup_support': True,
        'lambda_eata': 1.3938591858110283,
        'learning_rate': 3.435851230188726e-05,
        'lr_decay': 0.5710305429834551,
        'max_fisher_updates': 32,
        'memory_size': 2048,
        'momentum': 0.7053883347198695,
        'num_epochs': 60,
        'online_fisher': True,
        'pre_learning_rate': 0.00010837612189672898,
        'quantile': 0.3351682767276036,
        'safety_keep_frac': 0.39946907962777833,
        'step_size': 19,
        'steps': 2,
        'tau': 5,
        'temperature': 0.58716114864319,
        'train_backbone_modules': None,
        'train_classifier': False,
        'train_full_backbone': False,
        'use_eata_reg': False,
        ...
        'use_quantile': True,
        'warmup_min': 9,
        'weight_decay': 1.460219524879825e-05,
    },

    backbone_scenario('CNN', 1, 0): {
        'batch_size': 160,
        'd_margin': 0.1117279486451536,
        'e_margin_scale': 0.5998200855504571,
        'filter_K': 7,
        'fisher_alpha': 5679.192924336478,
        'freeze_bn_stats': True,
        'grad_clip': 0.638940866982898,
        'grad_clip_value': None,
        'include_warmup_support': True,
        'lambda_eata': 0.8953823600525005,
        'learning_rate': 0.00021044760503846982,
        'lr_decay': 0.34745053899684375,
        'max_fisher_updates': 1024,
        'memory_size': 2304,
        'momentum': 0.6719383667991068,
        'num_epochs': 42,
        'online_fisher': True,
        'pre_learning_rate': 6.44647654122566e-05,
        'quantile': 0.7721487155296067,
        'safety_keep_frac': 0.3882619931149223,
        'step_size': 29,
        'steps': 2,
        'tau': 5,
        'temperature': 0.6317861013627015,
        'train_backbone_modules': ['conv_block1'],
        'train_classifier': True,
        'train_full_backbone': False,
        'use_eata_reg': False,
        ...
        'use_quantile': False,
        'warmup_min': 269,
        'weight_decay': 2.273242533591626e-05,
    },

    backbone_scenario('CNN', 1, 2): {
        'batch_size': 144,
        'd_margin': 0.12661254322204163,
        'e_margin_scale': 0.5224733267923132,
        'filter_K': 7,
        'fisher_alpha': 2678.482632113978,
        'freeze_bn_stats': True,
        'grad_clip': 0.9840800581657853,
        'grad_clip_value': 0.1,
        'include_warmup_support': False,
        'lambda_eata': 0.7973724590740667,
        'learning_rate': 3.1578178173331254e-05,
        'lr_decay': 0.6519537114692223,
        'max_fisher_updates': 256,
        'memory_size': 1280,
        'momentum': 0.7539053149178216,
        'num_epochs': 54,
        'online_fisher': True,
        'pre_learning_rate': 0.0003617799436554893,
        'quantile': 0.7067643475882364,
        'safety_keep_frac': 0.6340330134650465,
        'step_size': 26,
        'steps': 5,
        'tau': 5,
        'temperature': 2.190186071342214,
        'train_backbone_modules': ['conv_block1', 'conv_block2'],
        'train_classifier': False,
        'train_full_backbone': False,
        'use_eata_reg': False,
        ...
        'use_quantile': True,
        'warmup_min': 11,
        'weight_decay': 0.0008436473453388751,
    },

    backbone_scenario('CNN', 2, 3): {
        'batch_size': 128,
        'd_margin': 0.0018213413244130804,
        'e_margin_scale': 0.40473471046384557,
        'filter_K': 9,
        'fisher_alpha': 1854.9954808004957,
        'freeze_bn_stats': True,
        'grad_clip': 0.3445461619254844,
        'grad_clip_value': None,
        'include_warmup_support': True,
        'lambda_eata': 0.7358950542017806,
        'learning_rate': 0.0001221384649480465,
        'lr_decay': 0.6590274555135814,
        'max_fisher_updates': 512,
        'memory_size': 3328,
        'momentum': 0.9283648535663322,
        'num_epochs': 41,
        'online_fisher': False,
        'pre_learning_rate': 0.00028875361848418806,
        'quantile': 0.8129192117603325,
        'safety_keep_frac': 0.21783855963910706,
        'step_size': 21,
        'steps': 4,
        'tau': 24,
        'temperature': 1.5888132013019018,
        'train_backbone_modules': None,
        'train_classifier': False,
        'train_full_backbone': False,
        'use_eata_reg': False,
        ...
        'use_quantile': True,
        'warmup_min': 168,
        'weight_decay': 8.327334939710841e-05,
    },
...
EEG_ACCUP_SCENARIO_OVERRIDES = {
    backbone_scenario('CNN', 0, 11): {
        'batch_size': 136,
        'd_margin': 0.03216172573389355,
        'e_margin_scale': 0.5107591812491252,
        'filter_K': 7,
        'fisher_alpha': 7895.429206969295,
        'freeze_bn_stats': True,
        'grad_clip': 0.566413178959871,
        'grad_clip_value': 0.25,
        'include_warmup_support': True,
        'lambda_eata': 0.5104017787294084,
        'learning_rate': 9.038068615001532e-05,
        'lr_decay': 0.6534844813166683,
        'max_fisher_updates': 1024,
        'memory_size': 3584,
        'momentum': 0.7836616865893656,
        'num_epochs': 43,
        'online_fisher': True,
        'pre_learning_rate': 0.0002812164305372896,
        'quantile': 0.27538186279314225,
        'safety_keep_frac': 0.6283080059782381,
        'step_size': 20,
        'steps': 2,
        'tau': 26,
        'temperature': 2.699169624647854,
        'train_backbone_modules': ['conv_block1', 'conv_block2'],
        'train_classifier': False,
        'train_full_backbone': False,
        'use_eata_reg': False,
        ...
        'use_quantile': True,
        'warmup_min': 272,
        'weight_decay': 6.856513774351397e-05,
    },
    ...
    backbone_scenario('CNN', 7, 18): {
        ...
        'filter_K': 9,
        'fisher_alpha': 5008.536254227752,
        'freeze_bn_stats': True,
        'grad_clip': 0.3581278342620853,
        'grad_clip_value': 0.1,
        'include_warmup_support': True,
        ...
        'quantile': 0.17105593286397314,
        'safety_keep_frac': 0.3831586955141348,
        'step_size': 22,
        'steps': 5,
        'tau': 24,
        'temperature': 1.1072707537141044,
        'train_backbone_modules': None,
        'train_classifier': False,
        'train_full_backbone': False,
        'use_eata_reg': True,
    ...
    backbone_scenario('CNN', 9, 14): {
        ...
        'e_margin_scale': 0.7972596844882633,
        'filter_K': 15,
        'fisher_alpha': 5998.512340682715,
        'freeze_bn_stats': True,
        'grad_clip': 0.8646402368630005,
        'grad_clip_value': 0.25,
        'include_warmup_support': False,
        ...
        'quantile': 0.647016342889798,
        'safety_keep_frac': 0.5250050659384953,
        'step_size': 30,
        'steps': 2,
        'tau': 13,
        'temperature': 0.6538443522136541,
        'train_backbone_modules': ['conv_block1', 'conv_block2'],
        'train_classifier': False,
        'train_full_backbone': False,
        'use_eata_reg': False,
    ...
    backbone_scenario('CNN', 12, 5): {
        ...
        'e_margin_scale': 0.36198398670988635,
        'filter_K': 13,
        'fisher_alpha': 3280.228731337742,
        'freeze_bn_stats': True,
        ...
        'quantile': 0.6700862178359747,
        'safety_keep_frac': 0.08412994435207588,
        'step_size': 25,
        'steps': 1,
        'tau': 16,
        'temperature': 1.938870253948175,
        'train_backbone_modules': None,
        'train_classifier': False,
        'train_full_backbone': False,
        'use_eata_reg': False,
    ...
    backbone_scenario('CNN', 16, 1): {
        ...
        'filter_K': 7,
        'fisher_alpha': 2586.373618914205,
        'freeze_bn_stats': True,
