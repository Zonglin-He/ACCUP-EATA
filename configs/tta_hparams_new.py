...
HAR_ACCUP_SCENARIO_OVERRIDES = {
    backbone_scenario('CNN', 7, 13): {
        'batch_size': 16,
        'd_margin': 0.1118344364442097,
        'e_margin_scale': 0.4108553589760432,
        'filter_K': 11,
        'fisher_alpha': 7212.202745650235,
        'freeze_bn_stats': True,
        'grad_clip': 0.6983391754562394,
        'grad_clip_value': 0.1,
        'include_warmup_support': False,
        'lambda_eata': 2.27613796358586,
        'learning_rate': 0.00048278353303051017,
        'lr_decay': 0.5922727487972831,
        'max_fisher_updates': 64,
        'memory_size': 768,
        'momentum': 0.8190978064579086,
        'num_epochs': 17,
        'online_fisher': True,
        'pre_learning_rate': 0.0001610587965767958,
        'quantile': 0.48067626766534427,
        'safety_keep_frac': 0.10422616597521961,
        'step_size': 58,
        'steps': 4,
        'tau': 25,
        'temperature': 2.6066082175250944,
        ...
        'use_quantile': True,
        'warmup_min': 150,
        'weight_decay': 1.0013947812643536e-05,
    },

    backbone_scenario('CNN', 9, 18): {
        'batch_size': 16,
        'd_margin': 0.10108162683506955,
        'e_margin_scale': 0.6408065981375014,
        'filter_K': 31,
        'fisher_alpha': 4477.1965085206075,
        'freeze_bn_stats': False,
        'grad_clip': 0.47024908721110714,
        'grad_clip_value': 0.1,
        'include_warmup_support': False,
        'lambda_eata': 0.508387455682477,
        'learning_rate': 4.019762293193072e-05,
        'lr_decay': 0.5938341127174435,
        'max_fisher_updates': 1024,
        'memory_size': 3328,
        'momentum': 0.7061684928425428,
        'num_epochs': 14,
        'online_fisher': True,
        'pre_learning_rate': 0.00016037814156666245,
        'quantile': 0.8697752470407337,
        'safety_keep_frac': 0.8403643460995,
        'step_size': 55,
        'steps': 3,
        'tau': 21,
        'temperature': 1.372490650682902,
        'train_backbone_modules': None,
        ...
        'use_quantile': True,
        'warmup_min': 49,
        'weight_decay': 0.00039182136068261115,
    },
