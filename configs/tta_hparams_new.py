...
FD_ACCUP_SCENARIO_OVERRIDES = {
    ...
    backbone_scenario('CNN', 2, 3): {
        'batch_size': 104,
        'd_margin': 0.06434618686702924,
        'e_margin_scale': 0.5032080463042319,
        'filter_K': 15,
        'fisher_alpha': 2087.115140661211,
        'freeze_bn_stats': False,
        'grad_clip': 0.8333959787344036,
        'grad_clip_value': 0.25,
        'include_warmup_support': True,
        'lambda_eata': 0.23483836296192617,
        'learning_rate': 9.178103658921877e-06,
        'lr_decay': 0.2646351463540092,
        'max_fisher_updates': 256,
        'memory_size': 2048,
        'momentum': 0.8339923483016802,
        'num_epochs': 25,
        'online_fisher': True,
        'pre_learning_rate': 0.0008112781856123612,
        'quantile': 0.1838003120192658,
        'safety_keep_frac': 0.8014800580014521,
        'step_size': 34,
        'steps': 1,
        'tau': 1,
        'temperature': 0.13790983394915463,
        'train_backbone_modules': None,
        'train_classifier': True,
        'train_full_backbone': True,
        'use_eata_reg': True,
        ...
        'use_quantile': False,
        'warmup_min': 100,
        'weight_decay': 0.0007459851624622251,
    },
