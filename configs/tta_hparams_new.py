...
FD_ACCUP_SCENARIO_OVERRIDES = {
    backbone_scenario('CNN', 0, 1): {
        'batch_size': 120,
        'd_margin': 0.018466382976188033,
        'e_margin_scale': 0.4541034957227807,
        'filter_K': 33,
        'fisher_alpha': 987.2869549755724,
        'freeze_bn_stats': True,
        'grad_clip': 0.4529376351396057,
        'grad_clip_value': 0.1,
        'include_warmup_support': True,
        'lambda_eata': 1.4710682796850072,
        'learning_rate': 0.0001024036415416113,
        'lr_decay': 0.7496860946483188,
        'max_fisher_updates': 64,
        'memory_size': 512,
        'momentum': 0.8617941085341294,
        'num_epochs': 36,
        'online_fisher': True,
        'pre_learning_rate': 0.0008820242008507919,
        'quantile': 0.08922539680188235,
        'safety_keep_frac': 0.8995139485699252,
        'step_size': 28,
        'steps': 3,
        'tau': 9,
        'temperature': 0.5155225284741013,
        ...
        'use_quantile': True,
        'warmup_min': 80,
        'weight_decay': 1.1364025472317931e-05,
    },
