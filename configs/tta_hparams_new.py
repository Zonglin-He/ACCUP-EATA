...
FD_ACCUP_SCENARIO_OVERRIDES = {
    ...
    backbone_scenario('CNN', 1, 0): {
        'batch_size': 160,
        'd_margin': 0.05,
        'e_margin_scale': 0.759022676139021,
        'filter_K': 101,
        'fisher_alpha': 3500,
        'freeze_bn_stats': True,
        'grad_clip': 1.0516566345197291,
        'grad_clip_value': 0.25,
        'include_warmup_support': True,
        'lambda_eata': 0.6,
        'learning_rate': 0.0001394121804496218,
        'lr_decay': 1.0,
        'max_fisher_updates': 128,
        'memory_size': 2048,
        'momentum': 0.9,
        'num_epochs': 20,
        'online_fisher': True,
        'pre_learning_rate': 5.9478751774466154e-05,
        'quantile': 0.9250617797674167,
        'safety_keep_frac': 0.8631899559187893,
        'step_size': 999,
        'steps': 3,
        'tau': 14,
        'temperature': 1.6673189434877278,
        'train_backbone_modules': ['conv_block1'],
        'train_classifier': True,
        'train_full_backbone': True,
        'use_eata_reg': True,
        ...
        'use_quantile': False,
        'warmup_min': 200,
        'weight_decay': 0.000603359308437887,
    },
    ...
    backbone_scenario('CNN', 1, 2): {
        ...
        'include_warmup_support': True,
        'lambda_eata': 1.0,
        'learning_rate': 4.381708917515363e-05,
        'lr_decay': 0.6283634120630465,
        'max_fisher_updates': 128,
        'memory_size': 2048,
        'momentum': 0.9666457881286609,
        'num_epochs': 59,
        'online_fisher': True,
        'pre_learning_rate': 6.813342831920063e-05,
        'quantile': 0.7078399824527944,
        'safety_keep_frac': 0.25,
        'step_size': 999,
        'steps': 1,
        'tau': 14,
        'temperature': 0.5,
